...
using Appointment_HospitalService.Service.Impl;
...
builder.Services.AddSingleton<AppointmentContext>();

builder.Services.AddScoped<IAppointment, AppointmentServiceImpl>();
